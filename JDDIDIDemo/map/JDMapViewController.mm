...
@interface JDMapViewController ()<BMKMapViewDelegate,BMKRouteSearchDelegate,BMKPoiSearchDelegate,BMKGeoCodeSearchDelegate,BMKLocationServiceDelegate>{
    //想要定位的位置
...
#pragma mark 显示公交
- (void)showBusLines {
    if (![JDMapViewController locationServicesEnabled]) {
        [self openGpsSetting];
        return;
    }
    //我的位置
