...
@interface JDMapManager ()<BMKGeneralDelegate,BMKLocationServiceDelegate,BMKGeoCodeSearchDelegate>

@property (nonatomic,strong) BMKMapManager *mapManager;
@property (nonatomic,strong) BMKGeoCodeSearch *geocodesearch;
@property (nonatomic,strong) BMKLocationService *locService;
@property (nonatomic,weak) id<JDMapLocationManagerDelegate> delegate;

@end

@implementation JDMapManager
+ (instancetype)sharedInstance{
    static dispatch_once_t once;
    static JDMapManager * __singleton__;
    dispatch_once( &once, ^{
